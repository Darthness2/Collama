...
# ---- check_syntax -----------------------------------------------------------
#
# Lightweight, dependency-free syntax linting the model can call before
# claiming an edit is "done". Each checker is a static, side-effect-free
# parser-only invocation — never executes the user code.
